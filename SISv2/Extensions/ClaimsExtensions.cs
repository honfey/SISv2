...
namespace SIS.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "SIS.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "SIS.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
